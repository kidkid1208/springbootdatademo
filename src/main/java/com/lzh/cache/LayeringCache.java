...
public class LayeringCache extends AbstractValueAdaptingCache {
    ...
    public LayeringCache(String name, RedisCache redisCache, com.github.benmanes.caffeine.cache.Cache<Object, Object> cache, boolean allowNullValues) {
    ...
    public ValueWrapper get(Object key) {
        ...
        logger.debug("查询一级缓存 key:{},返回值是:{}", key, wrapper==null?null:wrapper.toString());
        if (wrapper == null) {
            // 查询二级缓存
            wrapper = redisCache.get(key);
            logger.debug("查询二级缓存 key:{},返回值是:{}", key, wrapper==null?null:wrapper.toString());
        }
        return wrapper;
    }
